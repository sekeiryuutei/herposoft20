...
/** @var frontend\models\search\AgendapresupuestocategoriaSearch $searchModel */
...
$filename = "Resumen_AgendamientoPresupuesto_Categoria_" . $model->periodoAnio . '_' . ProcedimientosGenerales::nombreMes($model->periodoMes);
...
<div class="agendapresupuestocategoria-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            /*[
                ...
                'urlCreator' => function ($action, Agendapresupuestocategoria $model, $key, $index, $column) {

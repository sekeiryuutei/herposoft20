    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'template' => '{extraerdatapresupuesto} {viewdatapresupuesto} {viewdatainconsistencia}',
                ...
                'buttons' => [
                    ...
                    'extraerdatapresupuesto' => function ($url, $model) {                                
                        $t = Url::to([  'extraerdatapresupuesto', 
                                        'id' => $model->id
                                    ]);

                        return Html::button('<i class="fa fa-file-excel"></i>',[
                                    'value'=> $t,
                                    'title' => 'Subir Archivo Presupuesto Agendamiento',
                                    'class' => 'btn btn-default btn_upload',
                        ]);
                    },

                    'viewdatapresupuesto' => function ($url, $model) {                                
                        return Html::a('<i class="fa fa-list"></i>',
                                [   'viewdatapresupuesto', 'id' => $model->id], 
                                [
                                    'title' => 'Visualizar Consolidado Presupuesto',
                                    'class' => 'btn btn-default btn_view_presupuesto',
                                ]
                        );
                    },

                    'viewdatainconsistencia' => function ($url, $model) {                                
                        return Html::a('<i class="fa fa-comment"></i>',
                                [   'viewdatainconsistencia', 'id' => $model->id], 
                                [
                                    'title' => 'Visualizar Inconsistencia',
                                    'class' => 'btn btn-default btn_view_inconsistencia',
                                ]
                        );
                    },

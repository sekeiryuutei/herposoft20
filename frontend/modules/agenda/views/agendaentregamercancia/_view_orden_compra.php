...
$this->title = 'Agenda Entrega Mercancia';
...
<div class="agendaentregamercancia-form">
    ...
    <div class="row">
        <h5 class="title"><?php echo $crossdocking ?></h5>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 border-right">
            ...
            <div class="row">
                <h5 class="title">Datos Cita Entrega Mercancía</h5>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <?= 
                        $form->field($model, 'fechaAgenda')->widget(DatePicker::className(),[
                            'name' => 'fecha-agenda', 

...
/** @var common\models\search\TransferenciasWsSearch $searchModel */
    ...
    <?= GridView::widget([
        ...
        'columns' => [
			...
			[
				...
				'attribute' => 'Tipo_docto',
				'label' => 'Tipo Documento',
			],	
			[
				'attribute' => 'ConsecutivoERP',
				'label' => 'Consecutivo ERP',
			],	
			...
			*/
            /*[
                ...
                'urlCreator' => function ($action, TransferenciasWs $model, $key, $index, $column) {

...
/** @var frontend\models\search\SubcategoriaSearch $searchModel */
...
<?php
    Modal::begin([                
        'title'=>'<h4>Datos Básicos Subcategorías</h4>',
        'id'=>'modaldata',
        'size'=>'modal-lg',
        'options' => [
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($model){
                    return ($model->idCategoria) ? $model->categoria->nombre : '-';
                },
                'filter' => Categoria::getListaData(),                

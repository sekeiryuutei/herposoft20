...
use frontend\models\search\CrossdockingSearch;
...
/**
 * CrossdockingController implements the CRUD actions for Crossdocking model.
 */
class CrossdockingController extends Controller
{
    ...
    /**
     * Lists all Crossdocking models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new CrossdockingSearch();
    ...
    /**
     * Displays a single Crossdocking model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Creates a new Crossdocking model.
    ...
    /**
     * Updates an existing Crossdocking model.
    ...
    /**
     * Deletes an existing Crossdocking model.
    ...
    /**
     * Finds the Crossdocking model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return Crossdocking the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Crossdocking::findOne(['id' => $id])) !== null) {
            return $model;
        }

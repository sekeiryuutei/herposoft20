...
/**
 * AgendapresupuestocategoriaSearch represents the model behind the search form of `frontend\models\Agendapresupuestocategoria`.
 */
class AgendapresupuestocategoriaSearch extends Agendapresupuestocategoria
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['crossDocking', 'categoria', 'fechaLlegada'], 'safe'],
            [['cantidad'], 'number'],
        ];
    }
    ...
    {
        $query = Agendapresupuestocategoria::find()->where(['idAgendaPresupuesto' => $idagendapresupuesto]);
    ...
    public function searchPivotCategoriaDia($params, $idagenda, $lista = null, $categoria = null)
    {
        ...
        $datos = "(
            ...
            CASE 
                ...
                ELSE crossDocking
            END AS crossDocking, categoria, DAY(fechaLlegada) AS dia, cantidad
            FROM agendapresupuestocategoria 
        ...
        if ($this->categoria){
            $datos = $datos . ' AND categoria = ' . "'" . $this->categoria . "'";
        }
        ...
        " AS datos
            ...
            ORDER BY crossDocking, categoria
        ";
